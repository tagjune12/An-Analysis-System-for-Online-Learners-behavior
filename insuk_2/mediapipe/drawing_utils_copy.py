...
def draw_landmarks(
  ...
  POINT = (107, 55, 105, 52, 70, 46, 336, 285, 334, 282, 300, 276, 159, 144, 33, 133, 386, 373, 362, 263, 17, 61, 291, 0, 78, 308, 14, 13,
           10, 297, 389, 356, 288, 378, 152, 149, 58, 127, 162, 67, 50, 280)# 보기 편하게 12시 부터 1시간 단위  광대 50 , 280
  point_list = []
  success_flag = True
  try:
      for i in POINT:
          point_list.append(idx_to_coordinates[i])

  except Exception as e:
      print("오류오류", e)
      success_flag = False
      return point_list, success_flag

  point_list = np.array(point_list).ravel()
  # print(point_list)
  file_dot_index = file_name.find('.')
  point_list = np.insert(point_list, 0 , int(file_name[:file_dot_index]))
  # print(point_list)
  # print("point____list___shape",point_list.shape)
  return point_list, success_flag
